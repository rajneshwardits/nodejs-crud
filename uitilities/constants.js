export const message = {
    ...
    "add": (labal) => { return `${labal} added successfully.` },
    "fetch": (labal) => { return `${labal} fetched successfully.` },
    "update": (labal) => { return `${labal} updated successfully.` },
    "delete": (labal) => { return `${labal} deleted successfully.` },
}
